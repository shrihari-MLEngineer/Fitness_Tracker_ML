...
df[outlier_columns[:3] + ["label"]].boxplot(by="label", figsize=(20,10), layout=(1,3)) # accelerometer
df[outlier_columns[3:] + ["label"]].boxplot(by="label", figsize=(20,10), layout=(1,3)) # gyroscope
...
df[outlier_columns[:3] + ["label"]].plot.hist(by="label", figsize=(20,10), layout=(3,3)) # accelerometer
df[outlier_columns[3:] + ["label"]].plot.hist(by="label", figsize=(20,10), layout=(3,3)) # gyroscope
...
dataset,_,_ = mark_outliers_lof(df,outlier_columns)
for col in outlier_columns:
...
dataset,_,_ = mark_outliers_lof(df[df["label"]==label], outlier_columns)
for col in outlier_columns:
    plot_binary_outliers(dataset=dataset, col=col, outlier_col="outlier_lof" ,reset_index=True)
